      ...
      <div className="mx-auto w-full max-w-7xl">
        ...
        <div className="mb-14 flex items-end justify-between">
          ...
          <motion.div {...useReveal(0.1)} className="hidden sm:block">
            <Link
              href="/inspire"
              className="group flex items-center gap-1.5 rounded-full border border-border px-4 py-2 text-sm font-medium text-muted transition-all hover:border-muted hover:text-foreground"
            >

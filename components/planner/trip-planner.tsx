...
const desktopLeftTabActiveClass =
  "bg-neutral-200/80 font-semibold text-neutral-900 dark:bg-neutral-700/80 dark:text-white";
          ...
          {days.map((day) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "shrink-0 cursor-pointer rounded-full px-3.5 py-1.5 text-[13px] font-semibold transition-all",
  ...
  const mobileHeaderActions = (
    <div className="flex items-center gap-1.5">
      <button
        ...
        className={cn(
          "flex h-8 items-center gap-1.5 rounded-full px-3 text-[15px] font-medium transition-all",
          mobileActiveTab === "map"
                ...
                {(["chat", "itinerary", "ideas", "bookings"] as const).map(
                  (view) => (
                    <button
                      ...
                      className={cn(
                        "flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium transition-all",
                        leftView === view
